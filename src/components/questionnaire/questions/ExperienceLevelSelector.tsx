    ...
    <TooltipProvider delay={150} closeDelay={50}>
      <div className="space-y-0 overflow-hidden rounded-[var(--radius-lg)] border border-[color:var(--border)]">
        ...
        <RadioGroup
          ...
          className="flex w-full border-t border-[color:var(--border)] gap-0"
        >
            ...
            return (
              <RadioGroupItem
                ...
                className={cn(
                  ...
                  "data-checked:bg-[color:color-mix(in_oklch,var(--primary)_14%,var(--card)_86%)] data-checked:text-[color:var(--foreground)]",
                  "hover:bg-[color:var(--accent)] hover:text-[color:var(--foreground)]"
                )}
              >
                ...
                <span
                  className={cn(
                    ...
                    "bg-transparent group-data-checked:bg-[color:var(--primary)]"
                  )}
                />
