...
const en = {
  ...
  nav: {
    ...
    footer: {
      ...
      kneeGuide: "Bike Fitting for Knee Pain",
      backPainGuide: "Bike Fitting for Lower Back Pain",
      saddleHeightGuide: "Saddle Height Guide",
      roadBikeFitGuide: "Road Bike Fit Guide",
      cleatGuide: "Cleat Position Guide",
