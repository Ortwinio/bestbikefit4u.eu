...
const nl = {
  ...
  nav: {
    ...
    footer: {
      ...
      saddleHeight: "Zadelhoogte calculator",
      saddleWidth: "Zadelbreedtecalculator",
      frameSize: "Framemaat calculator",
      ...
      kneeGuide: "Bikefitting bij kniepijn",
      backPainGuide: "Bikefitting bij rugpijn",
      saddleHeightGuide: "Zadelhoogte gids",
      roadBikeFitGuide: "Wegfiets fit gids",
      cleatGuide: "Cleatpositie gids",
  ...
  home: {
    ...
    bikeShowcase: {
      ...
      cardAriaLabel: "Bekijk details van {brand} {model}",
      geometryVerified: "Geometrie geverifieerd",
      stackLabel: "Stack",
      reachLabel: "Reach",
      ettLabel: "ETT",
      staLabel: "ZHK",
      htaLabel: "VHK",
      wheelbaseLabel: "Wielbasis",
      tyreLabel: "Band",
      frontLabel: "Voor",
      rearLabel: "Achter",
      pressureUnit: "bar",
  ...
  dashboard: {
    ...
    saddleSelector: {
      title: "Zadelkiezer",
      subtitle: "Vind je zadelbreedte en vorm op basis van anatomie en rijprofiel.",
      anatomy: "Anatomie",
      ridingProfile: "Rijprofiel",
      currentSaddle: "Huidig zadel",
      symptoms: "Symptomen",
      calculate: "Bereken zadelaanbeveling",
      save: "Aanbeveling opslaan",
      saved: "Aanbeveling opgeslagen.",
      measuredMode: "Ik heb een zitbeenmeting",
      estimatedMode: "Schatten vanuit lichaamsgegevens",
      sitBoneWidth: "Zitbeenbreedte",
      height: "Lengte",
      weight: "Gewicht",
      hipCircumference: "Heupomtrek",
      flexibility: "Flexibiliteit",
      coreStability: "Core-stabiliteit",
      fromProfile: "Uit je profiel",
      bike: "Fiets",
      selectBike: "Kies fiets",
      ridingType: "Rijtype",
      positionStyle: "Houding",
      indoorOutdoor: "Indoor / outdoor",
      typicalRideLength: "Gebruikelijke ritduur",
      currentWidth: "Huidige zadelbreedte",
      currentFeel: "Hoe voelt het?",
      currentShape: "Huidige zadelvorm",
      currentTilt: "Huidige zadelkanteling",
      showOptional: "Optionele sectie tonen",
      hideOptional: "Optionele sectie verbergen",
      targetWidth: "Zadelbreedte",
      widthRange: "Bereik",
      confidence: "Betrouwbaarheid",
      saddleFamily: "Aanbevolen zadeltype",
      fitInteractionNotes: "Fit-interactienotities",
      previousRecommendations: "Vorige zadeladviezen",
      currentComparison: "Huidig zadel versus advies",
      noseType: "Neustype",
      profileShape: "Profielvorm",
      cutout: "Uitsparing aanbevolen",
      padding: "Padding",
      yes: "Ja",
      no: "Nee",
    },
    ...
    fit: {
      ...
      savedBikes: {
        ...
        title: "Kies een fiets",
        addNewBike: "Nieuwe fiets toevoegen",
        noBikes: "Nog geen fietsen toegevoegd",
        noBikesHint: "Voeg je eerste fiets toe om een gepersonaliseerde fit-sessie te starten.",
        addFirstBike: "Voeg je eerste fiets toe",
        usingBike: "Opgeslagen fiets gebruiken",
        usingBikeAttribute: "We gebruiken de opgeslagen fietswaarde:",
        missingBikeAttribute: "Deze fiets mist een rijstijl of doel.",
        completeBikeSetup: "Fiets aanvullen",
      ...
      reportV2: {
        ...
        shell: {
          ...
          aboutBullets: [
            ...
            "Gebruik de notities en spanningsadviezen voordat je grotere setup-aanpassingen doet.",
        ...
        rider: {
          anonymousRider: "Rijder",
          subtitle: "Lichaamsmaten gebruikt voor deze fit",
          height: "Lengte",
          weight: "Gewicht",
        ...
        scoreMeta: {
          flexibility: {
            ...
            descriptions: {
              1: "Je komt zittend met gestrekte benen niet tot je knieën.",
              2: "Je komt zittend tot halverwege het scheenbeen.",
              3: "Je komt zittend tot de enkels.",
              4: "Je komt zittend tot de tenen.",
              5: "Je komt zittend voorbij de tenen.",
            },
          },
          coreStability: {
            ...
            descriptions: {
              1: "Plank minder dan 20 seconden vol te houden.",
              2: "Plank 20-40 seconden vol te houden.",
              3: "Plank 40-60 seconden vol te houden.",
              4: "Plank 60-90 seconden vol te houden.",
              5: "Plank 90+ seconden vol te houden met sterke vorm.",
            },
          },
          comfort: {
            title: "Comfort & ongemak",
            labels: {
              1: "Ernstig ongemak",
              2: "Duidelijk ongemak",
              3: "Matig ongemak",
            ...
            descriptions: {
              1: "Pijn is sterk genoeg om het fietsen te beperken of te stoppen.",
              2: "Pijn komt regelmatig terug en beïnvloedt het fietsen.",
              3: "Ongemak verschijnt op langere of zwaardere ritten.",
              4: "Klein ongemak verschijnt alleen af en toe.",
        ...
        bike: {
          ...
          rideLength: "Typische ritlengte",
          positionPriority: "Positieprioriteit",
          typeOfRiding: "Type ritten",
          reportConfidence: "Fitzekerheid",
          algorithmVersion: "Algoritmeversie",
          engineVersion: "Engineversie",
          dataQuality: "Datakwaliteit",
          descriptionFallback:
    ...
    settings: {
      ...
      integrations: {
        ...
        bikeImport: {
          ...
          summaryAttention: "{count} aandacht nodig",
          overviewBikesLabel: "Strava-fietsen",
          overviewImportedLabel: "Geïmporteerd",
          overviewReadyLabel: "Fit-ready",
          overviewAttentionLabel: "Aandacht nodig",
          overviewCountNote: "Fietsen gevonden in je Strava-account",
          overviewImportedNote: "Al gekoppeld aan je lokale bibliotheek",
          overviewReadyNote: "Direct bruikbaar in fit-sessies",
          overviewAttentionNote: "Type- of setupcontrole nodig",
          lifetimeDistanceLabel: "Totale afstand",
          recentDistanceLabel: "Recente afstand",
          recentDistanceNote: "Laatste 90 dagen",
          recentRideCountLabel: "Aantal ritten",
          averageRideDistanceLabel: "Gem. ritafstand",
          averageSpeedLabel: "Gem. snelheid",
          lastRideLabel: "Laatste rit",
          importStateLabel: "Importstatus",
          availableInStrava: "Beschikbaar in Strava",
          fitReady: "Fit-ready",
          needsFitSetup: "Setup nodig",
          noUsageData: "Recente ritgegevens verschijnen na de eerste sync.",
          noRecentRides: "Geen recente ritten",
          noBrandModel: "Geen merk- of modelinformatie",
          syncWarningTitle: "Strava-sync heeft aandacht nodig",
          syncReady: "Klaar om te importeren",
          syncImported: "Geïmporteerd",
          syncError: "Syncfout",
